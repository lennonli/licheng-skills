...
name: ipo-kb
version: 1.0.0
title: "IPO Inquiry Case Knowledge Base Search"
summary: "Local search over 1,600+ IPO/NEEQ listing-review inquiry cases (2023-2026) and the securities rules library; auto-clones the knowledge base on first run"
read_when:
  - User asks about IPO or NEEQ listing-review inquiry questions or precedent cases
  - User needs inquiry focus points, response approaches or evidence chains on topics such as nominee shareholding, VAM clauses, horizontal competition, related-party transactions
  - User asks for the text of securities rules or exchange listing rules
...
description: |
  IPO与挂牌审核问询案例库检索（本地知识库，2023-2026四个年度共1,600+份，定期更新）。
